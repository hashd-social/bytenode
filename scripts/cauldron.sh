...
echo -e "${CYAN}   APP_REGISTRY_ADDRESS: ${APP_REGISTRY_ADDRESS:-'NOT SET'}${NC}"
...
echo -e "${GREEN}   APP_REGISTRY_ADDRESS: ${APP_REGISTRY_ADDRESS:-'NOT SET'}${NC}"
...
echo -e "${YELLOW}   APP_REGISTRY_ADDRESS: ${APP_REGISTRY_ADDRESS:-'NOT SET'}${NC}"
